...
export default function NewIdeaPage() {
  ...
  async function handleSubmit() {
    const newIdea: Omit<IdeaType, 'id' | 'createdAt' | 'upvotes' | 'views'> = {
      title: title.trim(),
      ...
      author: {
        ...
        avatarUrl: '', // upload logic to fill
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <div>
          <Link to="/ideas" className="text-blue-600 hover:underline">
            <LucideArrowLeft size={25} color="blue" className="inline-block" />
          </Link>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          {step === 1 && (
            <>
              ...
              <div>
                <label className="block font-medium mb-1">Estimated Time</label>
                <input
